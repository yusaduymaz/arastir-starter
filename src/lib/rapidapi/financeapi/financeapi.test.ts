...
describe('Finance API Client', () => {
  if (process.env.RAPIDAPI_LIVE_TESTS === '1') {
    it('should get quotes', async () => {
      // This test requires a valid RAPIDAPI_FINANCEAPI_KEY environment variable
    ...
    it('should skip live tests', () => {
      console.log('Skipping live Finance API client tests. Set RAPIDAPI_LIVE_TESTS=1 to run them.');
